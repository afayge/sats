...
__alpha_meta__ = {
    "id": "barra_style_residual_volatility",
    "display_name": "Barra-style Residual Volatility",
    "theme": ["residual_volatility", "volatility"],
    "formula_latex": "rolling_std(stock_ret - beta * benchmark_ret, 60)",
...
def compute(panel: dict[str, pd.DataFrame]) -> pd.DataFrame:
    ...
    residual = returns.sub(beta.mul(bench, axis=0))
    return finite(residual.rolling(60, min_periods=40).std())
